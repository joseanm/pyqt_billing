...
#
# Created: Sun May 01 21:31:03 2011
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.page_2.setGeometry(QtCore.QRect(0, 0, 230, 596))
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8(":/images/res/view-pim-tasks.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnCierreAnual.setIcon(icon5)
        ...
        self.gridLayout.addWidget(self.btnCierreAnual, 11, 0, 1, 1)
        ...
        self.btnCierreMensual.setIcon(icon5)
        ...
        self.gridLayout.addWidget(self.btnCierreMensual, 10, 0, 1, 1)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/res/object-locked.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionLockSession.setIcon(icon6)
        self.actionLockSession.setObjectName(_fromUtf8("actionLockSession"))
        self.actionUnlockSession = QtGui.QAction(MainWindow)
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/res/object-unlocked.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionUnlockSession.setIcon(icon7)
        self.actionUnlockSession.setVisible(False)
        self.actionUnlockSession.setObjectName(_fromUtf8("actionUnlockSession"))
        self.actionCuentas = QtGui.QAction(MainWindow)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/res/view-bank-account.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionCuentas.setIcon(icon8)
        self.actionCuentas.setObjectName(_fromUtf8("actionCuentas"))
        self.toolBar.addAction(self.actionLockSession)
        self.toolBar.addAction(self.actionUnlockSession)
        self.toolBar.addAction(self.actionCuentas)
...
"Bancaria", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionCuentas.setText(QtGui.QApplication.translate("MainWindow", "Cuentas", None, QtGui.QApplication.UnicodeUTF8))
        self.actionCuentas.setToolTip(QtGui.QApplication.translate("MainWindow", "Catálogo de Cuentas Contables", None, QtGui.QApplication.UnicodeUTF8))
